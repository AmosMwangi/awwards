...
class Profile(models.Model):
    Profile_photo = models.ImageField(default='person.png', upload_to = 'images/',blank=True)
...
class Project(models.Model):
    ...
    project_url = models.CharField(max_length =400)
    location = models.CharField(max_length =30)
    profile = models.ForeignKey(Profile, null = True,related_name='project', on_delete=models.CASCADE)
...
class Rate(models.Model):
    ...
    project = models.ForeignKey(Project,related_name='rate',null=True, on_delete=models.CASCADE)
